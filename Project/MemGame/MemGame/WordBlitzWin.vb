Public Class WordBlitzWin
    Private Sub WordBlitzWin_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        TimeDisplay.Text = My.Forms.WordBlitzGame.lblTimer.Text
        Dim TimeVar As Double = TimeDisplay.Text
        Dim BTimeDisplay As Double = My.Forms.WordBlitzGame.BestTimeDisplay
        If BTimeDisplay = 0 Then
            BestTimeDisplay.Text = "No time recorded yet"
        Else
            BestTimeDisplay.Text = My.Forms.WordBlitzGame.BestTimeDisplay
        End If
